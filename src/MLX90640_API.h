...
#define MLX90640_CTRL_MEAS_MODE_MASK MLX_BIT_MASK(12)
...
typedef struct
    ...
    //int MLX90640_TriggerMeasurement(uint8_t slaveAddr); We will not be using one shot mode
